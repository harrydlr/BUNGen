...
| y_block_nodes_vec | `list ∈ N^{block\_number} \mid \sum_{i=1}^{\texttt{block\_number}} x_i = \texttt{rows}`          | number of nodes per block in the y-axis.                                                                                                             |
| x_block_nodes_vec | `list ∈ N^{block\_number} \mid \sum_{i=1}^{\texttt{block\_number}} x_i = \texttt{cols}` | number of nodes per block in the x-axis.                                                                                                             |
